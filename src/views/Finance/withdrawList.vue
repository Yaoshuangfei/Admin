<template>
	<section>
		...
		<el-table :data="table" border highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column prop="toubiao" label="状态" width="120">
			</el-table-column>
			<el-table-column prop="fs_time" label="审核人" width="120">
			</el-table-column>
			<el-table-column label="操作" width="150">
				<template scope="scope">
					<el-button type="text" size="small" @click="handleEdit(scope.$index, scope.row)">审核/查看</el-button>
		...
		<!--编辑界面-->
		<el-dialog title="提现审核" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="提现支行：">
					{{editForm.name}}
				</el-form-item>
				<el-form-item label="银行卡号：">
					{{editForm.name}}
				</el-form-item>
				<el-col :span="5"><h2>提现金额（元）：</h2></el-col>
				<el-col :span="6"><h2 style="color:red;">{{editForm.yhkje}}</h2></el-col>
				<el-col :soan='10'>
				...
				<el-form-item>
					<el-input type="textarea" v-model="editForm.addr" placeholder="请输入备注说明"></el-input>
				</el-form-item>
			</el-form>
			<div slot="footer" class="dialog-footer">
				<el-button type="primary" @click.native="editFormVisible = false">审核通过</el-button>
				<el-button type="primary" @click.native="editSubmit" :loading="editLoading">审核不通过</el-button>
			</div>
		</el-dialog>
