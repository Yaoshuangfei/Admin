<template>
	<section>
		...
		<el-table :data="table" border highlight-current-row v-loading="listLoading" style="width: 100%;min-width: 500px;">
			...
			<el-table-column prop="user_name" label="类型">
			</el-table-column>
			<el-table-column prop="loan" label="总金额">
			</el-table-column>
			<el-table-column prop="loan_number" label="操作金额">
			</el-table-column>
			<el-table-column prop="min_company" label="可用金额">
			</el-table-column>
			<el-table-column prop="interest_rate" label="代收金额">
			</el-table-column>
			<el-table-column prop="data_qx" label="交易对方">
			</el-table-column>
			<el-table-column prop="time" label="记录时间">
			</el-table-column>
			<el-table-column prop="toubiao" label="备注">
			</el-table-column>
