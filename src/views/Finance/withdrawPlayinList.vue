	...
	<section>
		...
		<el-dialog title="提现审核" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="120px" :rules="editFormRules" ref="editForm">
				...
				<el-col :spam='24' style='background:#eee;height: 20px;'></el-col>
				<el-col :span='24'>
				...
				<el-col :spam='24' style='background:#eee;height: 20px;margin-bottom: 20px;'></el-col>
				<!-- <el-form-item> -->
			...
			<div slot="footer" class="dialog-footer" style="text-align: left;margin-left: 40%">
				...
				<el-button type="primary" @click.native="editSubmit" :loading="editLoading">打款成功</el-button>
				<el-button type="primary" @click.native="editSubmit" :loading="editLoading">打款失败</el-button>
			</div>
		</el-dialog>
