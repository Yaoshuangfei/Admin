<template>
	<section>
		...
		<el-table :data="table" border highlight-current-row v-loading="listLoading" style="width: 100%;min-width: 1000px;">
			...
			<el-table-column prop="title" label="标的名称">
			</el-table-column>
			<el-table-column prop="mobilePhone" label="手机号码">
			</el-table-column>
			<el-table-column prop="realname" label="姓名">
			</el-table-column>
			<el-table-column prop="expectedAnnualRate" :formatter="formatter" label="年化收益">
			</el-table-column>
			<el-table-column prop="timeLimit" label="理财天数">
			</el-table-column>
			<el-table-column prop="createTime" label="购买时间">
			</el-table-column>
			<el-table-column prop="finishTime" label="到期时间">
			</el-table-column>
			<el-table-column prop="totalMoney" label="购买金额" >
			</el-table-column>
			<el-table-column prop="totalMoneyActual" label="实际购买金额" >
			</el-table-column>
			<el-table-column prop="toubiao" label="来源" >
			</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getlist() {
				...
				$.post(baseUrl+"/admin/subject/order/getList",
